...
[![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/RiemBase?color=green)](https://cran.r-project.org/package=RiemBase)
[![Travis build status](https://travis-ci.org/kisungyou/RiemBase.svg?branch=master)](https://travis-ci.org/kisungyou/RiemBase)
